...
public class ResourceLocks implements IResourceLocks {
	...
	private static org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ResourceLocks.class);
	...
	/**
	 * generates real LockedObjects for the resource at path and its parent folders.
	 * does not create new LockedObjects if they already exist
	 * 
	 * @param transaction
	 * @param path
