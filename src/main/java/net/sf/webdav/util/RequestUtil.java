...
public final class RequestUtil {
	...
	/**
	 * Append request parameters from the specified String to the specified Map. It
	 * is presumed that the specified Map is not accessed from any other thread, so
	 * no synchronization is performed.
	 * <p>
	 * <strong>IMPLEMENTATION NOTE</strong>: URL decoding is performed individually
	 * on the parsed name and value elements, rather than on the entire query string
