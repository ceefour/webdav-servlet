...
public class DoHead extends AbstractMethod {
    ...
    public DoHead(WebdavStore store, String dftIndexFile, String insteadOf404, ResourceLocks resourceLocks, MimeTyper mimeTyper, int contentLengthHeader, int debug) {
        this.store = store;
